...
//BOTONES
$("#btnNuevoPresupuesto").click(validarPresupuesto);
...
function validarPresupuesto(evento) {
    ...
    let nomPresupuesto = formulario_NuevoPresupuesto.nomPresupuesto.value.trim();
    ...
    if (nomPresupuesto.length == 0) {
        if (bValidarFormulario) {
            ...
            formulario_NuevoPresupuesto.nomPresupuesto.focus();
        }

        errorNombre = "<span style='color: red' <i class='fas fa-exclamation'></i></span> Falta el nombre.";
        formulario_NuevoPresupuesto.nomPresupuesto.classList.add("is-danger");

    } else {

        formulario_NuevoPresupuesto.nomPresupuesto.classList.remove("is-danger");
        formulario_NuevoPresupuesto.nomPresupuesto.classList.add("is-primary");
    }
