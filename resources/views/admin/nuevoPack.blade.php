...
@section('content')
  <div class="steps" id="stepsDemo">
   ...
   <form id="formulario_NuevoPack" class="formulario_NuevoPack" action="{{route('packs.store')}}" method="POST">
      @csrf       
        ...
        <div class="lg:w-3/4 sm:w-auto mx-auto">         
          <div class="step-content has-text-centered is-active">
                ...
                <div class="field-body">
                   <div class="field">
                      <div class="control px-12 py-1">
                        <input class="input is-rounded" name="nomPack" id="nomPack" type="text" autofocus data-validate="require">
                      </div>
                    </div>
                </div>
            </div>         
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control px-12 py-1 has-icon has-icon-right">
                      <input class="input is-rounded" type="number" name="precioPack" id="precioPack" Step=".01" data-validate="require">
                    </div>
                  </div>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-2">
              <button class="button btn-success is-rounded mb-1" type="submit" data-toggle="modal" data-target="#myModal" id="btnNuevoPack" name="btnNuevoPack">
              ...
              <button class="button btn-warning is-rounded " type="button" onclick="window.location='{{ route('packs.index') }}'" id="btnResetFormulario" name="btnResetFormulario">
                <span class="icon is-small">
