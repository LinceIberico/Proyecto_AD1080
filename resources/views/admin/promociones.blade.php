...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    {{-- <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">--}}
             <div class="card">                
                 <div class="card-body">                                                                
                    <table class="table table-striped table-bordered  display-nowrap" style="width:100%" id="tabla-promo">                        
                        <thead>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.fn.dataTable.ext.buttons.alert = { //aqui genero un boton adicional
            ...
            $('#tabla-promo').DataTable({
                procesing: true,
                serverSider: true,
                ajax: '{!! route('promociones.index') !!}',
        ...
        columns:[
            ...
            {data:'descuento',render: $.fn.dataTable.render.number( ',', '.', 2, '', ' %' ) , name:'descuento'},
        ...
        buttons:[
                {
                    ...
                    attr:  {                    
                        id: 'nueva-promo',
                        onclick: "window.location.href="+"'{{route('admin.promocion.create')}}'",
                    },                
