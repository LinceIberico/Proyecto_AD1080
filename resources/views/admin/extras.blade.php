...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="overflow-hidden shadow-xl sm:rounded-lg">
             <div class="card">
                 <div class="card-body">           
                    <table class="table table-striped table-bordered  display-nowrap " style="width:100%" id="tabla-extras">
                        <thead>
...
@section('js')
    ...
    var table = $('#tabla-extras').DataTable( {
        procesing: true,
        serverSider:true,
        ajax: '{!! route('extras.index') !!}',
        ...
        columns:[
            ...
            {data:'precioExtra',render: $.fn.dataTable.render.number( ',', '.', 2, '', ' €' ) , name:'precioExtra'},
        ...
        buttons:[
                {
                    ...
                    attr:  {                    
                        id: 'nueva-extra',
                        onclick: "window.location.href="+"'{{route('extras.create')}}'",
                    },                
